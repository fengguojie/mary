	...
	<div class="row">
	     <section class="col-lg-12 connectedSortable">
	        <div class="box box box-primary">
	            ...
	            <div class="box-body">
	                <table id="myDatatable" data-toggle="table" data-url="${request.contextPath!}/baseInfo/park/getNoLinkList"
	            ...
	            <div class="box-footer text-center">
	                   <button id="btn-link" type="submit" class="btn btn-primary" href="javascript:;">&nbsp;关联选中的停车场&nbsp;</button>
 ...
 <script type="text/javascript">
	$(function(){
		...
		$('#btn-link').click(function(){
	       	...
	       	$.post('${request.contextPath!}/system/user/linkParkById',"parks="+ JSON.stringify(parks) +"&id=" + $('#id').val(),
				function(data){
