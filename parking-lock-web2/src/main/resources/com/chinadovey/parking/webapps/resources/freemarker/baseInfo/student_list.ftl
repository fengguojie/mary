         ...
         <section class="col-lg-12 connectedSortable">
            <div class="box box box-primary">
                ...
                <div class="box-body">
                    ...
                    <table id="myDatatable" data-toggle="table" data-url="${request.contextPath!}/test/student/getList"
						data-side-pagination="server" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
						data-pagination="true" data-search="false"  data-field-text="根据车位号搜索"data-page-list="[10, 25, 50, 100, 200]">
					<thead>
						<tr>
							<th data-field="sno" data-align="left"  data-sortable="true">学号</th>
							<th data-field="sname" data-align="left" data-sortable="true">学生名称</th>
