	...
	<div class="row">
		<section class="col-lg-12 connectedSortable">
			<div class="box box box-primary">
				...
				<!-- /.box-header -->
				<div class="box-body">
						<@SecuValidate resource="com.chinadovey.parking.acl.BaseCompany">
							<p>
								<button type="button" class="btn btn-success add">&nbsp;添加&nbsp;</button>
							</p>
					    </@SecuValidate>
					<table id="myDatatable" data-toggle="table"
						data-url="${request.contextPath!}/baseInfo/company/getList" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
						data-side-pagination="server" data-pagination="true" data-search="true" data-field-text="按照机构名称搜索"  
						data-page-list="[10, 25, 50, 100, 200]">
						<thead>
							<tr>
								<th data-checkbox="true"></th>
								<th data-field="name"  data-align="left"  >机构名称</th>
								<th data-field="contactNumber"  data-align="left" >联系电话</th>
								<th data-field="linkmen" data-align="left" >联系人</th>
								<th data-field="email" data-align="left" >联系邮箱</th>
