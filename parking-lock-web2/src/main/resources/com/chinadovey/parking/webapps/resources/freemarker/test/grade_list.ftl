...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#" class="active">考试管理系统</a></li>
	</ol>
</section>
<!-- Main content -->
			...
			<div class="box box box-primary">
				...
				<div class="box-body">
					...
					<table id="myDatatable" data-toggle="table"
						data-url="${request.contextPath!}/test/grade/getList" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"
						...
						<thead>
							<tr>
								...
								<th data-field="gradeType"  data-align="left"  >科目成绩</th>
								<th data-field="grade"  data-align="left" >成绩</th>
...
function timeFormatter(value, row, index) {
	...
	function deleteRecord(id) {
		$.post(
						'${request.contextPath!}/test/grade/delete',
						'id=' + id,
						function(e) {
							if (e.result == 'SUCCESS') {
								$('#myModal').modal('hide');
								...
								$('#myDatatable')
										.bootstrapTable(
												'refresh',
												{
													url : '${request.contextPath!}/test/grade/getList'
												});
								setTimeout(function() {
									$("#success-info").hide();
								}, 3000);
