				...
				<div class="box-body">
					<form class="form-horizontal offset3" id="company-form">
						...
						<div class="form-group">	
							...
							<div class="col-sm-5">
								<input class="form-control" placeholder="请输入联系电话" id="contactNumber" name="contactNumber" value="${company.contactNumber!}"
									type="text" />
							</div>
						</div>
						<div class="form-group">
		...
		$("#company-form").validate(
				{
					...
					rules : {
							name : {
							remote : {
									url : "${request.contextPath!}/baseInfo/company/checkNameById",
									data : {
										name : function() {
											return $("#name").val()
										},
					...
					submitHandler : function() {
						...
						$.post('${request.contextPath!}/baseInfo/company/update',
								param, function(data) {
