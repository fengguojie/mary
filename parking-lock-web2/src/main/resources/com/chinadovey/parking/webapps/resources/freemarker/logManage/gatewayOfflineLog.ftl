...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="#" class="active">网关离线日志</a></li>
	</ol>
</section>
                            ...
                            <div class="box box box-primary">
                                ...
                                <div class="box-body">
                                 <div id="custom-toolbar">
                                    ...
                                    <table id="myDatatable" data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true"   
							    data-side-pagination="server" data-pagination="true" 
								data-page-size="10" data-search="true"  data-field-text="根据网关编号搜索"	>
									<thead>
										<tr>
											<th data-field="state" data-checkbox="true"></th>
											<th data-field="dasId" data-align="left" data-sortable="true">网关编号</th>
  	...
  	$('#query').click(function(){
		...
		if(couldSearch){
			$('#myDatatable').bootstrapTable('refresh',{
				url: "${request.contextPath!}/logManage/operateLog/getGatewayList?"+param
			});
		}else{
			alert("结束时间要大于开始时间！");
		}	
...
function operateStatusFormatter(value, row, index) {
    ...
    function drawPicture() {
			...
			if(compareDate()){
				...
				$('#myDatatable').bootstrapTable('refresh',{
				url: '${request.contextPath!}/logManage/operateLog/getGatewayList?start='+startDate+'&end='+endDate
			});
