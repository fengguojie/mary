...
public class DASSerialPortPackets implements ValuePackets {
	...
	public String toString() {
		...
		sb.append("DAS TAG:	");
		sb.append(ByteUtil.asHex(getDasTag()));
		sb.append('\n');
		sb.append("DAS ID:		");
		...
		sb.append('\n');
		sb.append("port1:      ");
		sb.append(ByteUtil.asHex(getPort1()));
		sb.append('\n');
		sb.append("wire1:      ");
		sb.append(ByteUtil.asHex(getWire1()));
		sb.append('\n');
		sb.append("channel1:      ");
		sb.append(ByteUtil.asHex(getChannel1()));
		sb.append('\n');
		sb.append("port2:      ");
		sb.append(ByteUtil.asHex(getPort2()));
		sb.append('\n');
		sb.append("wire2:      ");
		sb.append(ByteUtil.asHex(getWire2()));
		sb.append('\n');
		sb.append("channel2:      ");
		sb.append(ByteUtil.asHex(getChannel2()));
		sb.append('\n');
		return sb.toString();
	}
